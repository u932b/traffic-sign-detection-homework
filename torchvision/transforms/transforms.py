...
__all__ = ["Compose", "ToTensor", "ToPILImage", "Normalize", "Resize", "Scale", "CenterCrop", "Pad",
           ...
           "Grayscale", "RandomGrayscale", "Transform_Image"]
...
class Transform_Image(object):
    def __init__(self, ang_range=30, shear_range=5, trans_range=5):
        self.ang_range = ang_range
        self.shear_range = shear_range
        self.trans_range = trans_range
    def __call__(self, img):
       return F.transform_image(img,self.ang_range,self.shear_range,self.trans_range)
