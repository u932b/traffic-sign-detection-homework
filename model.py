...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv2_5 = nn.Conv2d(128, 128, kernel_size=5, padding=(2, 2))
        self.conv3 = nn.Conv2d(128, 128, kernel_size=5, padding=(2,2))
        self.conv3_5 = nn.Conv2d(128, 256, kernel_size=5, padding=(5, 5))
        self.conv_drop = nn.Dropout2d()
        self.fc1 = nn.Linear(256*5*5, 50)
